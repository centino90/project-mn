    ...
    <div class="flex flex-wrap justify-between items-center border-b-2 border-secondary-100 py-6 md:justify-start md:space-x-10">
      ...
      <ul class="flex items-center justify-end">
        <?php if (isset($_SESSION['user_id'])) : ?>
          <a href="<?php echo URLROOT; ?>/users/logout" class="whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-primary-400 hover:bg-primary-500">
            Sign out
          </a>
        <?php else : ?>
