...
<div class="sidebar">
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo URLROOT ?>/about/" class="sidebar-nav-item <?php if ($data['current_route'] == 'index') : ?> active <?php endif ?>">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span class="mx-4 font-medium">About us</span>
        </a>
        <a href="<?php echo URLROOT ?>/about/privacyPolicy" class="sidebar-nav-item <?php if ($data['current_route'] == 'privacyPolicy') : ?> active <?php endif; ?>">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3" />
            </svg>
            <span class="mx-4 font-medium">Privacy policy</span>
        </a>
        <a href="<?php echo URLROOT ?>/about/termsOfService" class="sidebar-nav-item <?php if ($data['current_route'] == 'termsOfService') : ?> active <?php endif; ?>">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
