        ...
        <form action="<?php echo URLROOT; ?>/members/clinicInfo" method="POST">
            <header class="flex flex-wrap items-center justify-between gap-3 mb-10">
                <div class="w-64 flex-shrink-0">
                    <span class="text-2xl font-bold whitespace-nowrap">User data deletion instruction</span>
                </div>
            </header>

            <div class="flex flex-col text-lg lg:w-3/4 text-justify gap-y-8">
                <p>
                    By agreeing into our terms, you should already know that our organization keeps data for organizational use and that old/archived data are kept in storage as long as the organization deems it.
                </p>

                <p>Hence, you're not allowed to delete such information. However, changing them by updating your user profile is allowed.</p>
            </div>
        </form>
    </div>
</div>
