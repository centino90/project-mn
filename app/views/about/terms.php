    ...
    <div class="min-w-full px-4 lg:px-1">
        ...
        <form action="<?php echo URLROOT; ?>/members/clinicInfo" method="POST">
            ...
            <div class="flex flex-col text-lg xl:w-3/4 text-justify gap-y-8">
                ...
                <h1 class="text-3xl font-semibold">INDENIFICATION</h1>
                ...
                <h1 class="text-3xl font-semibold">HIPAA COMPLIANCE</h1>
                To comply with the Health Insurance Portability and Accountability Act of 1996 (“HIPAA”), you agree that you will not submit any information or materials containing Protected Health Information (“PHI”). PHI is information or materials relating to an individual’s medical condition or care and from which an individual can be identified. You further agree to indemnify, defend and hold harmless the Company and its affiliates and their respective shareholders, officers, directors, agents and employees from, for and against any claim, demand or cause of action, including payments of reasonable attorneys’ fees and costs arising out of or related to any violation of HIPAA or failure to comply with the terms of this section. If the Company determines that you have distributed PHI on the Website without de-identifying it as required by HIPAA, it will so notify you and may suspend or terminate your right to access the Website.
