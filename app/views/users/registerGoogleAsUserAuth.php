  ...
  <div class="max-w-lg w-full space-y-8 lg:px-8 lg:py-10">
    <div>
      <h2 class="mt-6 text-center text-3xl font-extrabold text-secondary-900">
        Notice: Your email is already taken. 
        You can instead add google authentication as a secondary option.
        Do you still want to continue?
      </h2>
    </div>
    <form class="mt-8" action="<?php echo URLROOT; ?>/users/registerGoogleAsUserAuth" method="post">
